  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-28 px-4'>
        <div className='text-center'>
            ...
            <p className='text-Black/75 capitalize md:w-2/3 mx-auto mb-8'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quis esse sapiente illum, quae ullam placeat vero sit nisi repellat nam!</p>
        </div>
                ...
                <SwiperSlide key={product.id}>
                    ...
                    <div className='mt-4 px-4'>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <p className='font-semibold'>{product.price}KSH.</p>
                        </div>
                    </div>
                </SwiperSlide>
            ))
